...
import { Alert, Box, Button, Card, CardContent, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Divider, List, ListItemButton, ListItemText, Typography } from '@mui/material';
    ...
    <PageWrapper>
      ...
      <ContentLayer>
        ...
        <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap', justifyContent: 'center', pb: 4 }}>
          <Button variant="contained" size="large" sx={actionButtonSx('#c62828', '#b71c1c')} onClick={handleCreateGame} disabled={isCreating}>
