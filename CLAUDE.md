...
└── games/
    ...
    ├── games.service.ts           # createGame, listGames, getGame, getPlayers, joinGame (max 4, dealForGameType al 4°), getHand, playCard, getGameState, deleteGame
